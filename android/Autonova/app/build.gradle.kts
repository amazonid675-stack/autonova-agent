...
android {
    ...
    compileSdk = 35
    defaultConfig { applicationId = "im.autonova.mobile"; minSdk = 26; targetSdk = 35; versionCode = 6; versionName = "0.6.0"; testInstrumentationRunner = "androidx.test.runner.AndroidJUnitRunner"; buildConfigField("String", "DEFAULT_SERVER_ORIGIN", "\"\"") }
