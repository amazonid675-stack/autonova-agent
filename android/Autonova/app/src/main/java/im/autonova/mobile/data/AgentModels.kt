...
data class ImprovementRecord(val id: String, val scope: String, val title: String, val proposedChange: String, val evidence: String, val testOutcome: String, val benchmarkSummary: String, val versionLabel: String, val status: String, val reviewNote: String = "")
data class TaskEvidence(val id: String, val taskId: String, val kind: String, val toolKey: String = "", val summary: String, val evidence: String = "", val outcome: String)
data class ModelCapability(val modality: String, val route: String, val availability: String, val note: String)
